public class Car extends Vehicle {
    ...
    public void changeSpeed(int newSpeed,int newDiection){
        move(newSpeed,newDiection);
        System.out.println("Change Speed Mthod called: Speed ->"+newSpeed+"direction->"+newDiection);
    }
